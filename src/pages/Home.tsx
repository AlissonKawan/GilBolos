...
export const Home = () => {
  ...
  return (
    <div className="font-sans overflow-x-hidden">
      {/* Hero Section (Fades in immediately) */}
      ...
      <section className="py-16 bg-white border-b border-stone-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <ScrollReveal delay={0} className="p-6 text-center space-y-4 hover:bg-brand-accent/30 rounded-2xl transition-colors duration-200">
            ...
            {/* Feature 2 */}
            <ScrollReveal delay={100} className="p-6 text-center space-y-4 hover:bg-brand-accent/30 rounded-2xl transition-colors duration-200">
              <div className="inline-flex p-3.5 bg-pink-100 text-brand-primary rounded-xl">
            ...
            {/* Feature 3 */}
            <ScrollReveal delay={200} className="p-6 text-center space-y-4 hover:bg-brand-accent/30 rounded-2xl transition-colors duration-200 sm:col-span-2 lg:col-span-1">
              <div className="inline-flex p-3.5 bg-pink-100 text-brand-primary rounded-xl">
      ...
      <section className="py-16 md:py-20 bg-stone-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal className="flex flex-col sm:flex-row justify-between items-center mb-12 gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {portfolioItems.map((item, idx) => (
              <ScrollReveal
                key={item.id}
                delay={(idx % 3) * 100}
                className="bg-white border border-stone-100 rounded-3xl overflow-hidden hover:shadow-xl transition-all duration-305 flex flex-col group relative"
              >
                {/* Product Image */}
