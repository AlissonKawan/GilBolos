...
export const products: Product[] = [
  {
    ...
    sizes: ['1.0 kg (aprox. 8 a 10 fatias)', '1.5 kg (aprox. 12 a 15 fatias)', '2.0 kg (aprox. 18 a 20 fatias)']
  },
  {
    id: '2',
    ...
    sizes: ['Caixa com 6 unidades', 'Caixa com 12 unidades', 'Caixa com 24 unidades']
  },
  {
    id: '3',
    ...
    longDescription: 'Nossos cupcakes unem beleza e sabor. Massa leve aromatizada com fava natural de baunilha, recheio surpresa de geleia de framboesa ácida artesanal e uma cobertura clássica de buttercream de merengue suíço tingido de rosa pastel. Decorado com confeitos elegantes de açúcar e framboesas frescas.',
    price: 15.00,
    ...
    sizes: ['Unidade individual', 'Caixa com 4 unidades', 'Caixa com 6 unidades', 'Caixa com 12 unidades']
  },
  {
    id: '4',
    ...
    sizes: ['Caixa com 10 unidades', 'Caixa com 25 unidades', 'Caixa com 50 unidades', 'Cento (100 unidades)']
  },
  {
    id: '5',
    ...
    price: 110.00,
    image: '/images/strawberry_cake.png', // Usando imagens de reserva mas mantendo bonito
    ingredients: ['Massa Red Velvet com cacau e buttermilk', 'Cream cheese premium', 'Manteiga', 'Extrato de baunilha', 'Frutas vermelhas'],
    sizes: ['1.2 kg (aprox. 10 a 12 fatias)', '2.0 kg (aprox. 18 a 20 fatias)']
  },
  {
    id: '6',
    ...
    sizes: ['Pequeno (3kg - até 30 pessoas)', 'Médio (5kg - até 50 pessoas)', 'Grande (8kg - até 85 pessoas)']
  }
];
